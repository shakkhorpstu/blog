...
$statement = $db->prepare("SELECT * FROM news WHERE category_name = 'National' ORDER BY id DESC");
$statement->execute();
...
$statement = $db->prepare("SELECT * FROM news WHERE category_name = 'national' ORDER BY id DESC LIMIT $start, $limit");
$statement->execute();
