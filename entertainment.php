...
$statement = $db->prepare("SELECT * FROM news WHERE category_name = 'Entertainment' ORDER BY id DESC");
$statement->execute();
...
$statement = $db->prepare("SELECT * FROM news WHERE category_name = 'Entertainment' ORDER BY id DESC LIMIT $start, $limit");
$statement->execute();
